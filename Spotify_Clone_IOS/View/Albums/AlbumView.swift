        ...
        ZStack {
            ...
            VStack {
                ZStack {
                    ...
                    SpotifyRemoteImage(urlString: albumVM.artist.image)
                        ...
                        LazyVStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(spacing: 20) {
                                ...
                                LazyVStack(spacing: 0) {
                                    ForEach(0..<min(4,albumVM.tracks.count), id: \.self) { index in
                                        TrackRowCell(
                                            track: albumVM.tracks[index],
                                            index: index + 1
                                        )
...
//                                albumVM.getTracksBySlugArtist(slug: slugArtist)
                            }
...
//                                albumVM.getAlbumsBySlugArtist(slug: slugArtist)
                            ...
                            ScrollView(.horizontal, showsIndicators: false) {
                                LazyHStack(spacing: 15) {
                                    ForEach(albumVM.tracks.indices.reversed(), id: \.self) { index in
                                        let sObj = albumVM.tracks[index]
                            ...
                            ScrollView(.horizontal, showsIndicators: false) {
                                LazyHStack(spacing: 15) {
                                    ForEach(albumVM.artists.indices, id: \.self) { index in
                                        
                                        let sObj = albumVM.artists[index]
