...
struct EditAlbumView: View {
    @StateObject private var albumVM = EditAlbumViewModel()
    ...
    var body: some View {
                ...
                VStack(spacing: 24) {
                            ...
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .overlay(
                                    Group {
                                        ...
                                        } else if !albumVM.album.image.isEmpty {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12)
                            .fill(albumVM.canUpdateAlbum ? Color.green : Color.gray.opacity(0.3))
                    )
                    .disabled(!albumVM.canUpdateAlbum || albumVM.isLoading)
                    .padding(.horizontal, 20)
                    .padding(.bottom, 40)
                }
            }
        ...
        .onAppear {
            albumVM.getAlbumBySlug(slug: slug)
        }
